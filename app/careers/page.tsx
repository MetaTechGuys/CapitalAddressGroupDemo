...
import CarCover from "../components/CarCover/CarCover";
...
export default function Careers() {
  ...
  const sections = useMemo(() => [
    { id: 'car-cover', component: <CarCover />, name: t('navbar.home') },
    { id: 'cards', component: <Cards />, name: t('navbar.services') },
    { id: 'car-form', component: <CarForm />, name: t('navbar.contact') },
    { id: 'logo', component: <Logo />, name: t('navbar.about') },
