    ...
    >
      <div className="navbar__container">
        ...
        <div className="navbar__actions">
          ...
          {/* Theme Toggle */}
          <button
            className={`navbar__action-btn navbar__theme-toggle ${isDarkTheme ? 'dark' : 'light'}`}
            onClick={toggleTheme}
            aria-label={t("navbar.toggle_theme")}
          >
            <div className="navbar__theme-toggle-container">
              {/* Moon Icon */}
              <svg
                width="18"
                height="18"
                viewBox="0 0 24 24"
                className={`navbar__theme-icon navbar__theme-icon--moon ${isDarkTheme ? 'active' : ''}`}
                fill="currentColor"
              >
              ...
              <div className="navbar__theme-toggle-track">
                <div className="navbar__theme-toggle-thumb"></div>
              </div>
              ...
              <svg
                ...
                height="18"
                viewBox="0 0 24 24"
                className={`navbar__theme-icon navbar__theme-icon--sun ${!isDarkTheme ? 'active' : ''}`}
                fill="currentColor"
              >
