...
import CoCover from "../components/CoCover/CoCover";
import CoCompany from "../components/CoCompany/CoCompony";
import CoCoverPer from "../components/CoCoverPer/CoCoverPer";
import CoPerson from "../components/CoPerson/CoPerson";
...
export default function Consulate() {
  ...
  const sections = useMemo(() => [
    { id: 'co-cover', component: <CoCover />, name: t('navbar.home') },
    { id: 'co-company', component: <CoCompany />, name: t('navbar.company') },
    { id: 'co-cover-per', component: <CoCoverPer />, name: t('navbar.personal') },
    { id: 'co-person', component: <CoPerson />, name: t('navbar.team') },
    { id: 'co-vid', component: <CoVid />, name: t('navbar.video') },
